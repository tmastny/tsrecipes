...
Tuning clusters is not necessarily something I'd recommend. s
Clustering takes a long time, even if we are using the precomputed
distance matrix. 

And there are much better options for dimensionality reduction. Using the
discrete cosine transform with 8 coefficients is almost as accurate as 64
clusters. 32 coefficients brings the accuracy to 92%.
