...
1. how standard methods mislead time series clustering

2. dynamic time warping distance as a method for intutitive similarity
...
```{r}
dtw::dtw(eth_sample_trunc$ts[[1]], eth_sample_trunc$ts[[2]]) %>%
  dtw::dtwPlotTwoWay(
...
```{r}
dtw::dtw(eth_sample_trunc$ts[[1]], eth_sample_trunc$ts[[3]]) %>%
  dtw::dtwPlotTwoWay(
