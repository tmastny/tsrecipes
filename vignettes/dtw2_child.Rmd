...
To evaluate the fit of the forecast and the actual data, 
we calculated the Euclidean distance between the corresponding points
in the time series and the forecasts.
